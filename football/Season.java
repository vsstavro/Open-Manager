...
public class Season {
    ...
    public Season() throws IOException {
        week=1;
    ...
    public void pickTeam()
    {
        ...
        table.teams_temp.get(n-1).setUser(true);
    }

    public Team picked()
    {
        for(int i=0; i<table.teams_temp.size(); i++)
            if (table.teams_temp.get(i).isUser())
                return table.teams_temp.get(i);
        return null;
    }
